...
### Defaults Setup ###
STORAGEDIR="/home/pg587_1/docker/backup";
NOW=`date "+%s"`;
...
cp -r /home/pg587_nb1/docker/play/upload $BACKUPDIR
tar cfvz $BACKUPDIR/upload.tar.bz2 $BACKUPDIR/upload
rm -rf $BACKUPDIR/upload
